...
initial_dataset <- data_personality %>%
  select(all_of(c(
    ...
    "education", "employment", "driving_freq", "income", "scrn_stopped_bzra"
  )))
...
categorical_vars <- c("sex", "gender", "prov_terr", "education", "employment", "driving_freq", "income", "scrn_stopped_bzra")
