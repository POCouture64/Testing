...
1. Entire Group Descriptive Stats; and
2. Group Comparison Based on Current or Past Use of BZRAs.

```{r}
#| label: Entire Group
######
# In this section I will include the code that will describe the entire sample. This section of the 
# code will not divide people based on whether or not they have stopped using BZRAs. I can also add  # more comparisons later such as by AEs or any other factors.
######
